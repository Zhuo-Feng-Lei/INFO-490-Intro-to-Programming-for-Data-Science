# -*- coding: utf-8 -*-
"""Copy of INFO490HP-P1

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1f-s2oKrs67AoOEmuR5aG689OT1Bfp7j0
"""
...
def get_character_counts_v2(chapters, names):
  ...
  counts = np.cumsum(np.array(py_data), axis = 1)
...
def simple_graph_hp(counts, names):
  ...
  subplot = fig.add_subplot(1,1,1)
  subplot.plot(counts)
  plt.suptitle('HP Characters Z.F.L')
  plt.xlabel('chapters')
  plt.ylabel('mentions')
  plt.xticks(np.arange(len(counts)), list(range(1, len(counts)+1)))
  plt.legend(names)
